...
const Appointment = () => {
  ...
  console.log(doctors, currencySymbol, backendUrl, token, getDoctorsData);
  ...
  const getAvailableSlots = async () => {
    ...
    let today = new Date();
    let allSlots = []; // Store all slots before updating state

    for (let i = 0; i < 7; i++) {
      let currentDate = new Date(today); // Copy current date
      ...
      if (i === 0) {
        // If today, set the starting time properly
